...
// Customer-facing production status must never expose an artifact body or its
// metadata. Both can contain internal review notes or execution details.
const customerArtifactSelect = 'id,project_id,workflow_run_id,kind,title,created_at';
